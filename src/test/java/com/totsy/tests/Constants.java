...
public class Constants {
    ...
    public static String DATA_START_OR="or";
    public static String DATA_SPLIT="\\|";
    public static String DATA_SPLIT_TYPE=":";
    public static String DATA_SPLIT_TYPE_SUB=",";
    public static String DATA_SPLIT_NAME="_";
